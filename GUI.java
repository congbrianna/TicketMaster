...
public class GUI implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
            ...
            buttonSavedUsername.addActionListener(new ActionListener() {
                public void actionPerformed(ActionEvent e) {
                    ...
                    if (sportButtonClickedNumber >= 2) {
                    	...
                    	t3 = new TicketTimer(concert, theatre, sports, concertAmount, theatreAmount, sportsAmount, concertButtonClickedNumber, theatreButtonClickedNumber, sportButtonClickedNumber, textStatingPositioninQueue);
        ...
        JButton refreshScreenOnSpotInQueue = new JButton("Refresh To Update Place in Queue");
        refreshScreenOnSpotInQueue.setFont(new Font("Sans Serif", Font.PLAIN, 17));
        refreshScreenOnSpotInQueue.setBounds(45, 450, 400, 30);
        refreshScreenOnSpotInQueue.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                t3.getTextStatingPositioninQueue();
                
            }
        });
        thirdPanel.add(refreshScreenOnSpotInQueue);
    }
        ...
        if (clicks >= 1) {
            ...
            buttonSavedUsername.addActionListener(new ActionListener() {
                public void actionPerformed(ActionEvent e) {
                    ...
                    System.out.println(concertButtonClickedNumber);
